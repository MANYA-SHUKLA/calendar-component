      ...
      <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 text-neutral-100/90 flex-wrap justify-center sm:justify-start">
            ...
            <span className="font-bold text-white text-xs sm:text-sm drop-shadow-lg">
              Manya Shukla
            </span>
            <span className="text-xs sm:text-sm font-medium">2025</span>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4 flex-wrap justify-center">
            ...
            <a
              ...
              className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-neutral-800/30 hover:bg-neutral-800/50 rounded-full text-neutral-100 text-xs sm:text-sm font-medium transition-all duration-200 hover:scale-110 hover:shadow-lg backdrop-blur-sm border border-primary-300/30 hover:border-primary-200/50"
            >
              <svg
                className="w-4 h-4"
                fill="none"
